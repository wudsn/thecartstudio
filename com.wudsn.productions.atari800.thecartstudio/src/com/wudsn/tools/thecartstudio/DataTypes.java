...
public final class DataTypes extends NLS {
	...
	public static DataType ContentType_CartridgeTypeNumericId = new DataType(Integer.class);
	...
	public static DataType WorkbookRoot_Title = new DataType(ASCIIString.class, 40, WorkbookRoot.TITLE_CHARACTERS);
	public static DataType WorkbookRoot_FlashTargetType = new DataType(FlashTargetType.class);
	public static DataType WorkbookRoot_BankCount = new DataType(Integer.class);
	public static DataType WorkbookRoot_BankSize = new DataType(MemorySize.class);
	public static DataType WorkbookRoot_CartridgeType = new DataType(CartridgeType.class);
	public static DataType WorkbookRoot_CartridgeMenuType = new DataType(CartridgeMenuType.class);
	public static DataType WorkbookRoot_UserSpaceSize = new DataType(MemorySize.class);
	public static DataType WorkbookRoot_GenreNames = new DataType(ASCIIString.class);

	public static DataType WorkbookGenre_Name = new DataType(ASCIIString.class, 20, WorkbookRoot.TITLE_CHARACTERS);

	public static DataType WorkbookEntry_Id = new DataType(Integer.class);
	public static DataType WorkbookEntry_Type = new DataType(WorkbookEntryType.class);
	...
	public static DataType WorkbookEntry_FileSize = new DataType(MemorySize.class);
	public static DataType WorkbookEntry_FileHeaderType = new DataType(FileHeaderType.class);
	public static DataType WorkbookEntry_ContentCRC32 = new DataType(Integer.class);
	public static DataType WorkbookEntry_ContentSize = new DataType(MemorySize.class);
	public static DataType WorkbookEntry_ContentType = new DataType(ContentType.class);
	public static DataType WorkbookEntry_DisplayMode = new DataType(DisplayMode.class);
	public static DataType WorkbookEntry_Parameters = new DataType(String.class);
	public static DataType WorkbookEntry_StartBankFixedIndicator = new DataType(Boolean.class);
	public static DataType WorkbookEntry_StartBankNumber = new DataType(Integer.class);
	public static DataType WorkbookEntry_RequiredBanksCount = new DataType(Integer.class);
	public static DataType WorkbookEntry_BanksAssignedIndicator = new DataType(Boolean.class);
	...
	public static DataType Preferences_UpdateCheckIndicator = new DataType(Boolean.class);
	public static DataType Preferences_EmulatorExecutablePath = new DataType(String.class);
	public static DataType Preferences_FreeBankColor = new DataType(Color.class);
	public static DataType Preferences_ReservedBankColor = new DataType(Color.class);
	public static DataType Preferences_ReservedUserSpaceBankColor = new DataType(Color.class);
	public static DataType Preferences_UsedOddBankColor = new DataType(Color.class);
	public static DataType Preferences_UsedEvenBankColor = new DataType(Color.class);
	public static DataType Preferences_ConflictBankColor = new DataType(Color.class);
