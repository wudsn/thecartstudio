...
public final class ContentType extends ValueSet {
	...
	public static final class Attributes {
		...
		public static final Attribute CARTRIDGE_TYPE_NUMERIC_ID = new Attribute("cartridgeTypeNumericId",
		...
		public static final Attribute INITIAL_BANK_NUMBER = new Attribute("initialBankNumber",
	...
	static {
		...
		UNKNOWN = add("UNKNOWN", CartridgeType.UNKNOWN, TheCartMode.TC_MODE_NOT_SUPPORTED);

		CARTRIDGE_STD_8 = add("CARTRIDGE_STD_8", CartridgeType.CARTRIDGE_STD_8, TheCartMode.TC_MODE_8K);
		CARTRIDGE_STD_16 = add("CARTRIDGE_STD_16", CartridgeType.CARTRIDGE_STD_16, TheCartMode.TC_MODE_16K);
		CARTRIDGE_OSS_034M_16 = add("CARTRIDGE_OSS_034M_16", CartridgeType.CARTRIDGE_OSS_034M_16,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_5200_32 = add("CARTRIDGE_5200_32", CartridgeType.CARTRIDGE_5200_32,
				TheCartMode.TC_MODE_NOT_SUPPORTED_5200);
		CARTRIDGE_DB_32 = add("CARTRIDGE_DB_32", CartridgeType.CARTRIDGE_DB_32, TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_5200_EE_16 = add("CARTRIDGE_5200_EE_16", CartridgeType.CARTRIDGE_5200_EE_16,
				TheCartMode.TC_MODE_NOT_SUPPORTED_5200);
		CARTRIDGE_5200_40 = add("CARTRIDGE_5200_40", CartridgeType.CARTRIDGE_5200_40,
				TheCartMode.TC_MODE_NOT_SUPPORTED_5200);
		CARTRIDGE_WILL_64 = add("CARTRIDGE_WILL_64", CartridgeType.CARTRIDGE_WILL_64, TheCartMode.TC_MODE_WILLIAMS64);
		CARTRIDGE_EXP_64 = add("CARTRIDGE_EXP_64", CartridgeType.CARTRIDGE_EXP_64, TheCartMode.TC_MODE_EXPRESS64);
		CARTRIDGE_DIAMOND_64 = add("CARTRIDGE_DIAMOND_64", CartridgeType.CARTRIDGE_DIAMOND_64,
				TheCartMode.TC_MODE_DIAMOND64);
		CARTRIDGE_SDX_64 = add("CARTRIDGE_SDX_64", CartridgeType.CARTRIDGE_SDX_64, TheCartMode.TC_MODE_SDX64);
		CARTRIDGE_XEGS_32 = add("CARTRIDGE_XEGS_32", CartridgeType.CARTRIDGE_XEGS_32, TheCartMode.TC_MODE_XEGS_32);
		CARTRIDGE_XEGS_64 = add("CARTRIDGE_XEGS_64", CartridgeType.CARTRIDGE_XEGS_64, TheCartMode.TC_MODE_XEGS_64);
		CARTRIDGE_XEGS_128 = add("CARTRIDGE_XEGS_128", CartridgeType.CARTRIDGE_XEGS_128, TheCartMode.TC_MODE_XEGS_128);
		CARTRIDGE_OSS_M091_16 = add("CARTRIDGE_OSS_M091_16", CartridgeType.CARTRIDGE_OSS_M091_16,
				TheCartMode.TC_MODE_OSS);
		CARTRIDGE_5200_NS_16 = add("CARTRIDGE_5200_NS_16", CartridgeType.CARTRIDGE_5200_NS_16,
				TheCartMode.TC_MODE_NOT_SUPPORTED_5200);
		CARTRIDGE_ATRAX_DEC_128 = add("CARTRIDGE_ATRAX_DEC_128", CartridgeType.CARTRIDGE_ATRAX_DEC_128,
				TheCartMode.TC_MODE_ATRAX128);
		CARTRIDGE_BBSB_40 = add("CARTRIDGE_BBSB_40", CartridgeType.CARTRIDGE_BBSB_40,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_5200_8 = add("CARTRIDGE_5200_8", CartridgeType.CARTRIDGE_5200_8,
				TheCartMode.TC_MODE_NOT_SUPPORTED_5200);
		CARTRIDGE_5200_4 = add("CARTRIDGE_5200_4", CartridgeType.CARTRIDGE_5200_4,
				TheCartMode.TC_MODE_NOT_SUPPORTED_5200);
		CARTRIDGE_RIGHT_8 = add("CARTRIDGE_RIGHT_8", CartridgeType.CARTRIDGE_RIGHT_8, TheCartMode.TC_MODE_8K_RIGHT);
		CARTRIDGE_WILL_32 = add("CARTRIDGE_WILL_32", CartridgeType.CARTRIDGE_WILL_32,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_XEGS_256 = add("CARTRIDGE_XEGS_256", CartridgeType.CARTRIDGE_XEGS_256, TheCartMode.TC_MODE_XEGS_256);
		CARTRIDGE_XEGS_512 = add("CARTRIDGE_XEGS_512", CartridgeType.CARTRIDGE_XEGS_512, TheCartMode.TC_MODE_XEGS_512);
		CARTRIDGE_XEGS_1024 = add("CARTRIDGE_XEGS_1024", CartridgeType.CARTRIDGE_XEGS_1024,
				TheCartMode.TC_MODE_XEGS_1024);
		CARTRIDGE_MEGA_16 = add("CARTRIDGE_MEGA_16", CartridgeType.CARTRIDGE_MEGA_16, TheCartMode.TC_MODE_MEGA_16);
		CARTRIDGE_MEGA_32 = add("CARTRIDGE_MEGA_32", CartridgeType.CARTRIDGE_MEGA_32, TheCartMode.TC_MODE_MEGA_32);
		CARTRIDGE_MEGA_64 = add("CARTRIDGE_MEGA_64", CartridgeType.CARTRIDGE_MEGA_64, TheCartMode.TC_MODE_MEGA_64);
		CARTRIDGE_MEGA_128 = add("CARTRIDGE_MEGA_128", CartridgeType.CARTRIDGE_MEGA_128, TheCartMode.TC_MODE_MEGA_128);
		CARTRIDGE_MEGA_256 = add("CARTRIDGE_MEGA_256", CartridgeType.CARTRIDGE_MEGA_256, TheCartMode.TC_MODE_MEGA_256);
		CARTRIDGE_MEGA_512 = add("CARTRIDGE_MEGA_512", CartridgeType.CARTRIDGE_MEGA_512, TheCartMode.TC_MODE_MEGA_512);
		CARTRIDGE_MEGA_1024 = add("CARTRIDGE_MEGA_1024", CartridgeType.CARTRIDGE_MEGA_1024,
				TheCartMode.TC_MODE_MEGA_1024);

		CARTRIDGE_SWXEGS_32 = add("CARTRIDGE_SWXEGS_32", CartridgeType.CARTRIDGE_SWXEGS_32,
				TheCartMode.TC_MODE_SXEGS_32);
		CARTRIDGE_SWXEGS_64 = add("CARTRIDGE_SWXEGS_64", CartridgeType.CARTRIDGE_SWXEGS_64,
				TheCartMode.TC_MODE_SXEGS_64);
		CARTRIDGE_SWXEGS_128 = add("CARTRIDGE_SWXEGS_128", CartridgeType.CARTRIDGE_SWXEGS_128,
				TheCartMode.TC_MODE_SXEGS_128);
		CARTRIDGE_SWXEGS_256 = add("CARTRIDGE_SWXEGS_256", CartridgeType.CARTRIDGE_SWXEGS_256,
				TheCartMode.TC_MODE_SXEGS_256);
		CARTRIDGE_SWXEGS_512 = add("CARTRIDGE_SWXEGS_512", CartridgeType.CARTRIDGE_SWXEGS_512,
				TheCartMode.TC_MODE_SXEGS_512);
		CARTRIDGE_SWXEGS_1024 = add("CARTRIDGE_SWXEGS_1024", CartridgeType.CARTRIDGE_SWXEGS_1024,
				TheCartMode.TC_MODE_SXEGS_1024);
		CARTRIDGE_PHOENIX_8 = add("CARTRIDGE_PHOENIX_8", CartridgeType.CARTRIDGE_PHOENIX_8,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_BLIZZARD_16 = add("CARTRIDGE_BLIZZARD_16", CartridgeType.CARTRIDGE_BLIZZARD_16,
				TheCartMode.TC_MODE_BLIZZARD);
		CARTRIDGE_ATMAX_128 = add("CARTRIDGE_ATMAX_128", CartridgeType.CARTRIDGE_ATMAX_128,
				TheCartMode.TC_MODE_ATARIMAX1);
		CARTRIDGE_ATMAX_1024 = add("CARTRIDGE_ATMAX_1024", CartridgeType.CARTRIDGE_ATMAX_1024,
				TheCartMode.TC_MODE_ATARIMAX8);
		CARTRIDGE_SDX_128 = add("CARTRIDGE_SDX_128", CartridgeType.CARTRIDGE_SDX_128,
				TheCartMode.TC_MODE_NOT_SUPPORTED);

		CARTRIDGE_OSS_8 = add("CARTRIDGE_OSS_8", CartridgeType.CARTRIDGE_OSS_8, TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_OSS_043M_16 = add("CARTRIDGE_OSS_043M_16", CartridgeType.CARTRIDGE_OSS_043M_16,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_BLIZZARD_4 = add("CARTRIDGE_BLIZZARD_4", CartridgeType.CARTRIDGE_BLIZZARD_4,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_AST_32 = add("CARTRIDGE_AST_32", CartridgeType.CARTRIDGE_AST_32, TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_ATRAX_SDX_64 = add("CARTRIDGE_ATRAX_SDX_64", CartridgeType.CARTRIDGE_ATRAX_SDX_64,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_ATRAX_SDX_128 = add("CARTRIDGE_ATRAX_SDX_128", CartridgeType.CARTRIDGE_ATRAX_SDX_128,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_TURBOSOFT_64 = add("CARTRIDGE_TURBOSOFT_64", CartridgeType.CARTRIDGE_TURBOSOFT_64,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_TURBOSOFT_128 = add("CARTRIDGE_TURBOSOFT_128", CartridgeType.CARTRIDGE_TURBOSOFT_128,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_ULTRACART_32 = add("CARTRIDGE_ULTRACART_32", CartridgeType.CARTRIDGE_ULTRACART_32,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_LOW_BANK_8 = add("CARTRIDGE_LOW_BANK_8", CartridgeType.CARTRIDGE_LOW_BANK_8,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_SIC_128 = add("CARTRIDGE_SIC_128", CartridgeType.CARTRIDGE_SIC_128,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_SIC_256 = add("CARTRIDGE_SIC_256", CartridgeType.CARTRIDGE_SIC_256,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_SIC_512 = add("CARTRIDGE_SIC_512", CartridgeType.CARTRIDGE_SIC_512, TheCartMode.TC_MODE_SIC);
		CARTRIDGE_STD_2 = add("CARTRIDGE_STD_2", CartridgeType.CARTRIDGE_STD_2, TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_STD_4 = add("CARTRIDGE_STD_4", CartridgeType.CARTRIDGE_STD_4, TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_RIGHT_4 = add("CARTRIDGE_RIGHT_4", CartridgeType.CARTRIDGE_RIGHT_4,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_BLIZZARD_32 = add("CARTRIDGE_BLIZZARD_32", CartridgeType.CARTRIDGE_BLIZZARD_32,
				TheCartMode.TC_MODE_NOT_SUPPORTED);

		CARTRIDGE_MEGAMAX_2048 = add("CARTRIDGE_MEGAMAX_2048", CartridgeType.CARTRIDGE_MEGAMAX_2048,
				TheCartMode.TC_MODE_MEGAMAX16);
		// Native The!Cart (8k mode)
		CARTRIDGE_THECART_8 = add("CARTRIDGE_THECART_8", CartridgeType.CARTRIDGE_STD_8, TheCartMode.TC_MODE_8K_THECART);
		CARTRIDGE_THECART_128M = add("CARTRIDGE_THECART_128M", CartridgeType.CARTRIDGE_THECART_128M,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_MEGA_4096 = add("CARTRIDGE_MEGA_4096", CartridgeType.CARTRIDGE_MEGA_4096,
				TheCartMode.TC_MODE_MEGA_4096);
		CARTRIDGE_MEGA_2048 = add("CARTRIDGE_MEGA_2048", CartridgeType.CARTRIDGE_MEGA_2048,
				TheCartMode.TC_MODE_MEGA_2048);
		CARTRIDGE_THECART_32M = add("CARTRIDGE_THECART_32M", CartridgeType.CARTRIDGE_THECART_32M,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_THECART_64M = add("CARTRIDGE_THECART_64M", CartridgeType.CARTRIDGE_THECART_64M,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_XEGS_8F_64 = add("CARTRIDGE_XEGS_8F_64", CartridgeType.CARTRIDGE_XEGS_8F_64,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_ATRAX_128 = add("CARTRIDGE_ATRAX_128", CartridgeType.CARTRIDGE_ATRAX_128,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		CARTRIDGE_ADAWLIAH_32 = add("CARTRIDGE_ADAWLIAH_32", CartridgeType.CARTRIDGE_ADAWLIAH_32,
				TheCartMode.TC_MODE_NOT_SUPPORTED);
		...
		FILE_SAP = add("FILE_SAP", CartridgeType.UNKNOWN, TheCartMode.TC_MODE_SAP_FILE);
	...
	/**
	 * Content types which are cartridge emulation types require a special alignment
	 * of the start bank for the entry. This method if the content type requires an
	 * alignment to a bank that has a number which is the next power of two greater
	 * or equal to the entry size.
	 * 
	 * @return <code>true</code> if the content type requires an alignment based on
	 *         its size.
	 */
	public boolean isAligmentRequired() {
		if (this == UNKNOWN || this == FILE_ATR || this == FILE_BINARY || this == FILE_EXECUTABLE || this == FILE_SAP) {
			return false;
		}
		return true;
	 ...
	 *         {@link TheCartMode#TC_MODE_NOT_SUPPORTED_5200} if the content type
	 *         cannot be emulated.
	 */
	...
	public ImportableMenu createImportableMenu(byte[] content) {
		if (this.equals(CARTRIDGE_ATMAX_128) || this.equals(CARTRIDGE_ATMAX_1024)) {
