...
public final class MainMenu {
	...
	public MainMenu(final ActionListener actionListener, final Preferences preferences) {
		...
		menu.addMenuListener(new MenuListener() {
			...
			public void menuSelected(MenuEvent e) {
				...
				for (int i = 0; i < filePathsList.size(); i++) {
					...
					menuItem.setActionCommand(Commands.OPEN_RECENT_FILE + ":" + filePath);
					menuItem.addActionListener(actionListener);
					menuItems.add(menuItem);

				}
				recentWorkbooksMenuItemList.setMenuItems(menuItems, openMenuItem.isEnabled());
			}
		...
		newMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_New, Commands.NEW_FILE);
		newMenuItem.addActionListener(actionListener);
		menu.add(newMenuItem);

		openMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_Open, Commands.OPEN_FILE);
		openMenuItem.addActionListener(actionListener);
		menu.add(openMenuItem);

		openFolderMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_OpenFolder, Commands.OPEN_FOLDER);
		openFolderMenuItem.addActionListener(actionListener);
		menu.add(openFolderMenuItem);

		saveMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_Save, Commands.SAVE_FILE);
		saveMenuItem.addActionListener(actionListener);
		menu.add(saveMenuItem);

		saveAsMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_SaveAs, Commands.SAVE_FILE_AS);
		saveAsMenuItem.addActionListener(actionListener);
		menu.add(saveAsMenuItem);

		closeMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_Close, Commands.CLOSE_FILE);
		...
		exportAsBinImageMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_ExportToBinImage,
				Commands.EXPORT_TO_BIN_IMAGE);
		exportAsBinImageMenuItem.addActionListener(actionListener);
		exportAsCarImageMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_ExportToCarImage,
				Commands.EXPORT_TO_CAR_IMAGE);
		exportAsCarImageMenuItem.addActionListener(actionListener);
		exportAsAtrImageMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_ExportToAtrImage,
				Commands.EXPORT_TO_ATR_IMAGE);
		exportAsAtrImageMenuItem.addActionListener(actionListener);
		exportAsAtrImagesMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_ExportToAtrImages,
		...
		menu.addSeparator();
		printMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_File_Print, Commands.PRINT);
		...
		addEntriesMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Edit_AddEntries, Commands.ADD_ENTRIES);
		addEntriesMenuItem.addActionListener(actionListener);
		menu.add(addEntriesMenuItem);

		addUserSpaceEntryMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Edit_AddUserSpaceEntry,
		...
		removeEntriesMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Edit_RemoveEntries,
				Commands.REMOVE_ENTRIES);
		removeEntriesMenuItem.addActionListener(actionListener);
		menu.add(removeEntriesMenuItem);

		setGenreMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Edit_SetGenre, Commands.SET_GENRE);
		setGenreMenuItem.addActionListener(actionListener);
		menu.add(setGenreMenuItem);

		assignNewBanksMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Edit_AssignNewBanks,
		...
		workbookOptionsMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Edit_WorkbookOptions,
		...
		menuBar.add(menu);
		previewMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Tools_Preview, Commands.PREVIEW);
		previewMenuItem.addActionListener(actionListener);
		menu.add(previewMenuItem);

		testMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Tools_Test, Commands.TEST);
		testMenuItem.addActionListener(actionListener);
		// menu.add(testMenuItem); Only for testing new functions during
		// development

		optionsMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Tools_Options, Commands.OPTIONS);
		...
		helpMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Help_ContentTypes,
				Commands.HELP_FILE_CONTENT_TYPES);
		helpMenuItem.addActionListener(actionListener);
		menu.add(helpMenuItem);

		helpMenuItem = ElementFactory.createMenuItem(Actions.MainMenu_Help_About, Commands.HELP_ABOUT);
		helpMenuItem.addActionListener(actionListener);
		menu.add(helpMenuItem);
	}
