	...
	private final static class TableModel extends AttributeTableModel {
		...
		public Object getValueAt(int row, int column) {
			...
			case Columns.SIZE_IN_KB:
				return Integer.valueOf(contentType.getCartridgeType().getSizeInKB() * KB);
			case Columns.CARTRDIGE_TYPE_NUMERIC_ID:
				return Integer.valueOf(contentType.getCartridgeType().getNumericId());
			case Columns.THE_CART_MODE:
				return Integer.valueOf(contentType.getTheCartMode());
			case Columns.BANK_SIZE:
				return Integer.valueOf(contentType.getCartridgeType().getBankSize());
			case Columns.START_BANK_NUMBER:
				return Integer.valueOf(contentType.getCartridgeType().getInitialBankNumber());
			default:
